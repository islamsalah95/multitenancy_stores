...
<div class="container">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('tenant.home') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('tenant.category', $product->category) }}">{{ $product->category->name }}</a></li>
                        ...
                        <div class="card h-100 product-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('tenant.product', $relatedProduct) }}" class="btn btn-sm btn-outline-primary">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
